...
const JAPANESE_BOOK_REVIEWS = [
  {
    ...
    title: "やせうま",
    rating: 5,
    image: "assets/BookCover2.webp",
    imageAlt: "やせうまの本の表紙",
    body: [
      "この本はとてもいいですよ。まず、本のしゃしんは面白いし、楽しいし、本のしゃしんが大好きです。「やせうま」の著者は日本語を勉強している学生だと思います。多分、著者はしゅくだいでこの本を書きました。でも、この本はおもしろいです。",
      "「やせうま」のトピックは食べ物です。やせはやせうまのシェフの名前です。「うまい」はおいしいと同じです。子供が言いたかったのは「やせ、うまい！」です。でも、子供は早口です。だから、食べ物の名前はやせうまです。とても面白いですね。",
      "さらに、「やせうま」のえはいいです。プロットは分かりやすいです。この本を読んでみてください。プロットはいいし、しゃしんは面白いし、「やせうま」は五つぼしです。でも、ちょっとみじかいです。",
    ],
    glossary: [
      ["著者", "Author"],
      ["言いたかった", "To intend to say"],
      ["早口", "Speak quickly"],
